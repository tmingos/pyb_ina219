...
Note: This file has been modified to remove dependency on logging library (not included
in ESP8266 MicroPython distro). Removing logging also reduces file size and enables
use of this library without having to use mpy-cross to compile this file into a .mpy file
